...
namespace Mes.Client.Utility
{
    public class Utils
    {
        ...
        {
            return GetCustomerMac(GetClientIP());
        }
        ...
        public static string GetHostName()
        {
            ...
            //else
            //{
            //    HostName = HttpContext.Current.Request.ServerVariables["HTTP_X_FORWARDED_FOR"];
            //}
        ...
        public static string GetNo(string Code)
        {
            ...
            string OdNo = Code + System.DateTime.Now.Year.ToString()
        ...
        #endregion
        #region 前面为NO990000的N位随机  订单编号   NO990000117582
        /// <summary>
        /// 前面为NO990000的N位随机  订单编号   NO990000117582
        /// </summary>
        /// <param name="N"></param>
        /// <returns></returns>

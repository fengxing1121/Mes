<%@ Page Title="销售报价" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="orderspricelist.aspx.cs" Inherits="Mes.Client.UI.View.Orders.orderspricelist" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Head" runat="server">
    <script src="/Script/forms/orders/jquery.forms.orderspricelist.js?ver=1.561"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="server">
     <div title="销售报价" region="center" style="border: 0px;" border="false">
        <!--搜索界面-->

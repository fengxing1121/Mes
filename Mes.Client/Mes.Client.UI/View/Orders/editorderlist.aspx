<%@ Page Title="订单修改" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="editorderlist.aspx.cs" Inherits="Mes.Client.UI.View.Orders.editorderlist" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Head" runat="server">
    <script src="/Script/forms/orders/jquery.forms.editorderlist.js?ver=1.561"></script>
</asp:Content>

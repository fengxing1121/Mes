<%@ Page Title="订单查询" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="orderslist.aspx.cs" Inherits="Mes.Client.UI.View.Orders.orderslist" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Head" runat="server">
    <script src="/Script/forms/orders/jquery.forms.orderslist.js?ver=1.23"></script>
</asp:Content>

<%@ Page Title="订单修改" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="editorder.aspx.cs" Inherits="Mes.Client.UI.View.Orders.editorder" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Head" runat="server">
    ...
    <script src="/Script/stream-v1/stream-v1.js?ver=1.2"></script>
     <script src="/Script/forms/orders/jquery.forms.editorder.js?ver=1.341"></script>
    <style type="text/css">
            ...
            <form id="edit_form" method="post" enctype="multipart/form-data" style="height: 100%;">
                   <div class="easyui-layout" fit="true" border="false">
                    <div region="north" border="false">
                        ...
                        <table style="width: 100%; height: auto; padding: 5px;">
                            <tr>
                                ...
                                <td>
                                    <input type="text" id="OutOrderNo" name="OutOrderNo" class="easyui-validatebox" style="width: 300px;"  required="true"  />
                                </td>
                    ...
                    <div region="center" border="false" style="padding: 0px; overflow: hidden; height: 80px;">
                        <table id="dgCabinet" title="添加订单产品（单击行编辑）"></table>
                    </div>
                    <div region="south" border="false" style="text-align: center; padding: 2px; overflow: hidden; height: 50px;">
                         <a id="btn_edit_save" icon="icon-ok"   class="easyui-linkbutton" href="javascript:void(0)">修改订单</a>

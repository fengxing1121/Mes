<%@ Page Title="财务审核" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ordersreview.aspx.cs" Inherits="Mes.Client.UI.View.Orders.ordersreview" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Head" runat="server">
    <script src="/Script/forms/orders/jquery.forms.ordersreview.js?ver=1.561"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="server">
    <div title="财务审核" region="center" style="border: 0px;" border="false">

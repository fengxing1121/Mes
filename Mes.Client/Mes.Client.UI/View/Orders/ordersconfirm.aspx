<%@ Page Title="订单初审" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ordersconfirm.aspx.cs" Inherits="Mes.Client.UI.View.Orders.ordersconfirm" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Head" runat="server">
    <script src="/Script/forms/orders/jquery.forms.ordersconfirm.js?ver=1.5612"></script>
</asp:Content>

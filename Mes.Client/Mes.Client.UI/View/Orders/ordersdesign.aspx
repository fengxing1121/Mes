<%@ Page Title="提交设计" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ordersdesign.aspx.cs" Inherits="Mes.Client.UI.View.Orders.ordersdesign" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Head" runat="server">
    <script src="/Script/forms/orders/jquery.forms.ordersdesign.js?ver=1.561"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="server">
     <div title="提交设计" region="center" style="border: 0px;" border="false">
        <!--搜索界面-->

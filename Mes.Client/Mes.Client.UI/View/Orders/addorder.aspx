<%@ Page Title="新增销售订单" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="addorder.aspx.cs" Inherits="Mes.Client.UI.View.Orders.addorder" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Head" runat="server">
    ...
    <script src="/Script/forms/orders/jquery.forms.addorder.js?ver=1.61"></script>
    <style type="text/css">

<%@ Page Title="角色管理" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Roles.aspx.cs" Inherits="Mes.Client.UI.View.Management.Settings.Roles" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Head" runat="server">
    <script src="/Script/forms/setting/roles.js?VER=1.2"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="server">
    <div id="div_role" region="west" title="用户角色" style="width: 400px;">         
    ...
    <div region="center" split="true" title="权限分配设置">
        <form id="edit_form_item" name="edit_form_item" method="post" style="width: 100%; height: 100%;">
            ...
            <div style="text-align: left; padding: 10px;">&nbsp&nbsp
                <a href="#" class="easyui-linkbutton" iconcls="icon-add" plain="true" id="btn_newgroup">添加用户组</a>&nbsp&nbsp
                <a href="#" class="easyui-linkbutton" iconcls="icon-add" plain="true" id="btn_newrole">添加角色</a>&nbsp&nbsp                
                <a href="#" class="easyui-linkbutton" id="btn_save" icon="icon-save">保存权限</a>
            </div>

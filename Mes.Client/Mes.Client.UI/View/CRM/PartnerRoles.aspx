<%@ Page Title="权限设置" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PartnerRoles.aspx.cs" Inherits="Mes.Client.UI.View.CRM.PartnerRoles" %>
    ...
    <div region="center" split="true" title="权限分配设置">
        <form id="edit_form_item" name="edit_form_item" method="post" style="width: 100%; height: 100%;">
            ...
            <div style="text-align: left; padding: 10px;">
                ...
                <a href="#" class="easyui-linkbutton" id="btn_save" icon="icon-save" style="width: 80px;">保存</a>
            </div>

<%@ Page Title="订单初审" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ordersconfirm.aspx.cs" Inherits="Mes.Client.UI.View.PartnerOrder.ordersconfirm" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Head" runat="server">
    <script src="/Script/forms/PartnerOrder/jquery.forms.ordersconfirm.js?ver=1.415"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="server">
    <div title="订单初审" region="center" style="border: 0px;" border="false">

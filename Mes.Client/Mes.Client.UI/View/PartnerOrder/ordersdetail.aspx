<%@ Page Title="订单详情" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ordersdetail.aspx.cs" Inherits="Mes.Client.UI.View.PartnerOrder.ordersdetail" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Head" runat="server">
    <script src="/Script/forms/PartnerOrder/jquery.forms.ordersdetail.js?ver=1.1"></script>
     <style type="text/css">
        #content ul li
        {
            float: left;
            ...
            <form id="search_form">
                ...
                <table style="width: 100%; height: 50px;">
                    <tr>
                        ...
                        <td style="width: 100px; text-align: right;display:none;">来源单号:
                        </td>
    ...
    <div region="center" border="false">
        <div class="easyui-layout" fit="true">
            ...
            <div region="south" border="false" style="text-align: center; padding: 2px; overflow: hidden; height: 50px;display:none;">
                 <a id="btn_confirm_open" icon="icon-ok" style="width:120px;height:30px;display:none;"  class="easyui-linkbutton" href="javascript:void(0)">订单审核</a>  
                 <a id="btn_Import" icon="icon-ok" style="width:120px;height:30px;display:none;"  class="easyui-linkbutton" href="javascript:void(0)">一键导入</a>                     
            </div>
        </div>
    </div>

    <div id="confirm_window" class="easyui-window" closed="true" title="订单审核" icon="icon-save"  style="width: 640px; height: 480px; background: #fff;display:none;" minimizable="false" maximizable="false">

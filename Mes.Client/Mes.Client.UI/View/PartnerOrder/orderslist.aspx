<%@ Page Title="订单查询" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="orderslist.aspx.cs" Inherits="Mes.Client.UI.View.PartnerOrder.orderslist" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Head" runat="server">
    <script src="/Script/forms/PartnerOrder/jquery.forms.orderslist.js?ver=1.56"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="server">
     <div title="订单查询" region="center" style="border: 0px;" border="false">
        <!--搜索界面-->

<%@ Page Title="预订单导入" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ordersimport.aspx.cs" Inherits="Mes.Client.UI.View.PartnerOrder.ordersimport" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Head" runat="server">
    <script src="/Script/forms/PartnerOrder/jquery.forms.ordersimport.js?ver=1.415"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="server">
     <div title="预订单导入" region="center" style="border: 0px;" border="false">
        <!--搜索界面-->

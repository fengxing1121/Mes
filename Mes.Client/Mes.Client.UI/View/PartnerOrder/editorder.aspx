<%@ Page Title="订单修改" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="editorder.aspx.cs" Inherits="Mes.Client.UI.View.PartnerOrder.editorder" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Head" runat="server">
    ...
    <script src="/Script/stream-v1/stream-v1.js?ver=1.2"></script>
     <script src="/Script/forms/PartnerOrder/jquery.forms.editorder.js?ver=1.415"></script>
    <style type="text/css">

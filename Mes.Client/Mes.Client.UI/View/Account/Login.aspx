<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Mes.Client.UI.View.Account.Login" %>
...
<head runat="server">
    ...
    <script src="../../Script/forms/login/login.js?ver=1.12"></script>
    <style>
...
<body>
    ...
    <div class="layadmin-user-login layadmin-user-display-show">
        <div class="layadmin-user-login-main"  style="background-color: #FCFBFB;">
            ...
            <div class="layadmin-user-login-box layadmin-user-login-body layui-form">
                <form class="layui-form" action="">
                    ...
                    <div class="layui-form-item" style="margin-bottom: 30px;" id="select">
                        <div>
    ...
    <div class="copyright-100" data-spm="999" style="overflow-x: hidden; overflow-y: hidden;">
        <div class="y-row copyright">
            <p class="big">
                <span><a href="http://gzmeiwu.com/" target="_blank">关于我们</a></span>
                <span><a href="http://gzmeiwu.com/" target="_blank">服务条款</a></span>
                <span><a href="http://gzmeiwu.com/" target="_blank">帮助中心</a></span>
                <span><a href="http://gzmeiwu.com/" target="_blank">用户手册</a></span>
            </p>
            <%--<p><span><a href="#" target="_blank">广州美屋互联网科技有限公司 </a></span></p>--%>
            <%--<p>Copyright ©  2016-<%=DateTime.Now.Year %> gzmeiwu.com 版权所有   </p>--%>
            <p>建议分辨率：1920*1080p 建议在谷歌或火狐浏览器使用</p>
        </div>
    </div>
</body>
</html>

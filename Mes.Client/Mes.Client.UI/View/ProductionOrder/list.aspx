<%@ Page Title="生产订单查询" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="list.aspx.cs" Inherits="Mes.Client.UI.View.ProductionOrder.list" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Head" runat="server">
     <script src="/Script/easyui/datagrid/datagrid-groupview.js"></script>
    <script src="/Script/forms/ProductionOrder/jquery.forms.list.js?ver=1.45"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="server">
     <div title="生产订单查询" region="center" style="border: 0px;" border="false">
        <!--搜索界面-->

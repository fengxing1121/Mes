<%@ Page Title="生产订单排单" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Schedulinglist.aspx.cs" Inherits="Mes.Client.UI.View.ProductionOrder.Schedulinglist" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Head" runat="server">
    <script src="/Script/easyui/datagrid/datagrid-groupview.js"></script>
    <script src="/Script/forms/ProductionOrder/jquery.forms.schedulinglist.js?ver=1.34"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="server">
     <div title="生产订单排单" region="center" style="border: 0px;" border="false">

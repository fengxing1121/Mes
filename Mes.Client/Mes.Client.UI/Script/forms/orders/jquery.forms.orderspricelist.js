...
var ordersForm = {
    ...
    events: {
                ...
                columns: [[
                    {
                        field: 'OrderNo', title: '订单编号', width: 120, align: 'center', formatter: function (value, rowData, rowIndex) {
                            var strReturn = '<a href="javascript:void(0)" class="l-btn-text" title="产品报价" onclick="ordersForm.events.orderprize(\'' + rowData['OrderID'] + '\',\'' + rowData['OrderNo'] + '\',\'' + rowData['StepNo'] + '\');"><span style="color:#0094ff;">' + rowData['OrderNo'] + '</span></a>';
                            return strReturn;
                        }
                    },
        ...
        orderprize: function (id, no, stepno) {
            top.addTab("报价【" + no + "】", "/View/orders/ordersprice.aspx?orderid=" + id + "&stepno=" + stepno + "&" + jsNC(), 'table');

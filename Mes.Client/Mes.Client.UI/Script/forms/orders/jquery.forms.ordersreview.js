...
var ordersForm = {
    ...
    events: {
                ...
                columns: [[
                    {
                        field: 'OrderNo', title: '订单编号', width: 120, align: 'center', formatter: function (value, rowData, rowIndex) {
                            var strReturn = '<a href="javascript:void(0)" class="l-btn-text" title="订单审核" onclick="ordersForm.events.showdetail(\'' + rowData['OrderID'] + '\',\'' + rowData['OrderNo'] + '\',\'' + rowData['StepNo'] + '\');"><span style="color:#0094ff;">' + rowData['OrderNo'] + '</span></a>';
                            return strReturn;
                        }
                    },
        ...
        showdetail: function (id, no, stepno) {
            top.addTab("审核【" + no + "】", "/View/orders/ordersdetail.aspx?orderid=" + id + "&stepno=" + stepno + "&source=review", 'table');

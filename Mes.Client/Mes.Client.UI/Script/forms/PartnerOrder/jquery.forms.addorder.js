    ...
    events: {
        ...
        OrderType: function () {
            $('#OrderType').combobox({
                ...
                textField: 'CategoryName',
                method: 'get',
                url: '/ashx/categoryhandler.ashx?Method=GetOrderType&whole=false',
                required: true,
            });
        },
        //保存
        saveorder: function () {
            ...
            addorderForm.controls.edit_form.form('submit', {
                url: '/ashx/PartnerOrderHandler.ashx?Method=SavePartnerOrder&' + jsNC(),
...
function showdetail(id, no) {
    top.addTab("查看【" + no + "】", "/View/PartnerOrder/ordersdetail.aspx?orderid=" + id + "&" + jsNC());
}

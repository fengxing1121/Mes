    ...
    events: {
        loadData: function () {
            ordersForm.controls.dgdetail.datagrid({
                ...
                toolbar: [
                    { text: '开始排单', iconCls: 'icon-cog', handler: ordersForm.events.SchedulingProductionOrder }
                ],
        ...
        SchedulingProductionOrder: function (id, no) {
            ...
            var url = '/ashx/ProductionOrderHandler.ashx?Method=SchedulingProductionOrder&' + jsNC();

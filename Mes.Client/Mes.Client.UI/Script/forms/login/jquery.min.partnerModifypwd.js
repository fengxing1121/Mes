(function ($) {
    ...
    var safeForm = {
        ...
        init: function () {
            ...
            var Config = $.extend(true, {}, safeForm.configs.formReset, 0);
            safeForm.formValidation = safeForm.controls.reset_form.smartValidator(Config);
        },
        ...
        events: {
            ...
            jumpSuccessForm: function () {
                ...
                //set title class
                var lis = $('.rn-reg-t-wrapper ul li');
                $(lis[0]).removeClass('current').addClass('r85');
                $(lis[1]).removeClass('r85').addClass('current');
                $(lis[2]).removeClass('nnext').addClass('l41');
            }
        },
        configs: {
            formReset: {
                ...
                onsubmit: function () {
                    ...
                    url = '/ashx/partnetLoginHandler.ashx?Method=ModifyPwd&v=' + Math.random();
                    // 隐藏custom tips

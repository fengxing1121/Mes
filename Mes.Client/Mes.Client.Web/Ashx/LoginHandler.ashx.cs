...
namespace Mes.Client.Web.Ashx
{
    ...
    public class LoginHandler : BaseHttpHandler
    {
        ...
        public void Login()
        {
            //string CodeTime = System.Configuration.ConfigurationManager.AppSettings["CodeTime"];
            //if (CodeTime!=DateTime.Now.ToShortDateString())
            //{
            //    SaveError(new Exception(CodeTime));
            //    throw new PException(CodeTime+"Error");
            //}
            try
            {
                ...
                using (ProxyBE be = new ProxyBE())
                {
                    ...
                    //{
                    //    if (user.Password == CEncrypt.EncryptString(UserDefaultPassword))
                    //    {
                    //        url = "/modifypwd.aspx";
                    //    }
                    //}

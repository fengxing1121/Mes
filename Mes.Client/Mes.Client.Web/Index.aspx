<%@ Page Title="全屋定制家具MES生产管理系统v1.0" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Mes.Client.Web.Index" %>

<asp:Content ID="HeadContent" ContentPlaceHolderID="Head" runat="server">
    <link href="/Content/css/ext_icons.css" rel="stylesheet" />
    <link href="/Content/css/Index.css" rel="stylesheet" />
    <script src="/Script/forms/jquery.min.form.index.js?ver=1.8"></script>
    <style>
        .tabs-inner{
            height:30px;
            padding:10px;
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="Main" runat="server">
    ...
    <div region="north" border="false" style="overflow: hidden; height: 50px; line-height: 50px; background: #0e0e0e; color: rgba(255,255,255,.7);">
        <div style="display: inline-block; float: right; height: 50px; line-height: 50px;">
            <span class="head" style="padding-right: 20px;">欢迎【<%=CurrentUser.UserCode+"."+CurrentUser.UserName %>】
            <a href="javascript:void(0);" id="editpass">修改密码</a>
                <a href="javascript:void(0);" id="loginOut">安全退出</a>
            </span>
        </div>
        <span style="padding-left: 50px; font-size: 16px;">全屋定制家具MES生产管理系统v1.0
        </span>
    </div>
    ...
    <div id="mainPanle" region="center" style="background: #eee; overflow-y: hidden">
        <div id="tabs" class="easyui-tabs" border="false" fit="true">
            <div iconcls="layout" title="我的工作台" region="center">
                <div style="height: 32px; text-align: right; padding-right: 10px; padding-top: 5px;">
                    ...
                    <%--<li class="item">
                        <div class="item_body">
                            <div class="item_title">
                                <img src="/Content/images/desktop/message_e.png" />                                
                                <div style="line-height: 72px; padding-top: 20px;"><span style="font-size: 20px; padding-left: 20px;">系统消息</span></div>
                            </div>
                            <div style="clear: both; height: 2px; border-bottom: 2px solid #eee;"></div>
                            <div class="desknav">
                                <ul style="padding-left:0px;">
                                    <li style="line-height: 25px;"><a href="#" rel="/portal/system/notice.aspx"><span class="icon comments">&nbsp;</span><span class="nav">生产异常消息</span></a></li>
                                    <li style="line-height: 25px;"><a href="#" rel="/portal/system/notice.aspx"><span class="icon comments">&nbsp;</span><span class="nav">审核任务消息</span></a></li>
                                    <li style="line-height: 25px;"><a href="#" rel="/portal/system/notice.aspx"><span class="icon comments">&nbsp;</span><span class="nav">系统消息</span></a></li>
                                    <li style="line-height: 25px;"><a href="#" rel="/portal/system/notice.aspx"><span class="icon comments">&nbsp;</span><span class="nav">任务提醒</span></a></li>
                                </ul>
                            </div>
                        </div>
                    </li>                   --%>

<%@ Page Title="仓库库存" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="store_products.aspx.cs" Inherits="Mes.Client.Web.View.Management.WareHouse.store_products" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Head" runat="server">
    <script src="/Script/forms/stock/jquery.forms.stocks.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="server">
    <div title="成品仓库库存" region="center" style="border: 0px;" border="false">
        <!--搜索界面-->

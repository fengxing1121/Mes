<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="hardware.aspx.cs" Inherits="Mes.Client.Web.View.Management.WareHouse.hardware" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Head" runat="server">
    <script src="/Script/forms/stock/jquery.forms.hardware.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="server">
     <div title="五金仓库库存" region="center" style="border: 0px;" border="false">
        <!--搜索界面-->

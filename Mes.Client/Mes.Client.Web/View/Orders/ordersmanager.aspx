<%@ Page Title="订单管理" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ordersmanager.aspx.cs" Inherits="Mes.Client.Web.View.Orders.ordersmanager" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Head" runat="server">
    <script src="/Script/forms/orders/jquery.forms.ordersmanager.js"></script>
</asp:Content>
        ...
        <div region="north" border="false" style="text-align: right; overflow: hidden;" id="search_window">
            <div style="height: auto 50px;" class="datagrid-toolbar">
                <form id="search_form" method="post">
                    <div>
                        <input type="hidden" id="Status" name="Status" value="Z,N,B" />
                    </div>
                    <table>
                        <tr>
    ...
    <div id="review_window" class="easyui-window" closed="true" title="订单确认" icon="icon-save"
        ...
        <div class="easyui-layout" fit="true" border="false">
            ...
            <div region="south" border="false" style="text-align: center; padding: 0px; overflow: hidden; height: 50px;">
                <a id="btn_review_ok" icon="icon-save" class="easyui-linkbutton" href="javascript:void(0)">确认通过</a> <a id="btn_review_reject"
                    icon="icon-cancel" class="easyui-linkbutton" href="javascript:void(0)">拒绝</a>
            </div>
        </div>
    </div>

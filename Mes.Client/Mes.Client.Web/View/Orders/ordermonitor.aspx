<%@ Page Title="订单生产监控" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ordermonitor.aspx.cs" Inherits="Mes.Client.Web.View.Orders.ordermonitor" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Head" runat="server">
    ...
    <script src="/Script/forms/orders/jquery.forms.ordermonitor.js?ver=1.422"></script>
</asp:Content>

<%@ Page Title="修改订单" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="editorder.aspx.cs" Inherits="Mes.Client.Web.View.Orders.editorder" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Head" runat="server">
    <script src="/Script/forms/orders/jquery.forms.editorder.js"></script>
</asp:Content>
            ...
            <form id="edit_form" method="post" enctype="multipart/form-data" style="height: 100%;">
                <div class="easyui-layout" fit="true" border="false">
                    <div region="north" border="false">
                        ...
                        <table style="width: 100%; height: auto; padding: 5px;">
                            <tr>
                                ...
                                <td>
                                    <input type="text" id="OrderNo" name="OrderNo" style="width: 300px;"   readonly="true" />
                                </td>
                               ...
                               <td class="lbl-caption">订单类型:
                                ...
                                <td>
                                    <select id="OrderType" name="OrderType" style="width: 200px;" class="easyui-combobox" required="true">
                            ...
                            <tr>
                                ...
                                <td>
                                    <select id="IsStandard" name="IsStandard" style="width: 200px;" class="easyui-combobox" required="true">
                                ...
                                <td>
                                    <select id="IsOutsourcing" name="IsOutsourcing" style="width: 200px;" class="easyui-combobox" required="true">                                        
                                        <option value="true">是</option>
                                        <option value="false">否</option>
                                    </select>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" id="BookingDate" name="BookingDate" class="easyui-datebox" style="width: 100%;" required="true"  />
                                </td>
                                 <td class="lbl-caption">交货日期:
                                </td>
                                <td>
                                    <input type="text" id="ShipDate" name="ShipDate" style="width: 100%;" class="easyui-datebox" required="true" />
                                </td>
                    ...
                    <div region="south" border="false" style="text-align: center; padding: 2px; overflow: hidden; height: 50px;">
                        <a id="btn_cancelorder" icon="icon-cancel" style="width:100px;height:30px;"   class="easyui-linkbutton" href="javascript:void(0)">取消订单</a>
                        <a id="btn_edit_save" icon="icon-save" style="width:100px;height:30px; " class="easyui-linkbutton" href="javascript:void(0)">提交订单</a>                       
                    </div>
                </div>
            </form>
        </div>

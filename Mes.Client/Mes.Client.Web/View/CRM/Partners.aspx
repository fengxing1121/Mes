<%@ Page Title="门店管理" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Partners.aspx.cs" Inherits="Mes.Client.Web.View.CRM.Partners" %>
                    ...
                    <div title="基本信息" style="padding: 10px" fit="true">
                        ...
                        <table cellpadding="3" id="tbPartnerInfo">
                            ...
                            <tr>
                                ...
                                <td style="width: 120px;">
                                    <input id="PartnerCode" name="PartnerCode" type="text" class="easyui-validatebox" readonly="true" placeholder="自动编号" value="自动编号"
                                        maxlength="30" />
                                </td>
                            </tr>
                            <tr  style="display: none;">
                                <td class="lbl-caption">工厂模板:<span style="color: red;">*</span>
                                </td>
                                <td style="width: 120px;">
                                    <select id="CompanyName" name="CompanyName" style="width: 125px;" class="easyui-combobox" required="true">
                                    </select>
                                    <input style="width: 120px; height: 22px; display: none" id="CompanyID" name="CompanyID" type="text" />
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr  style="display: none;">
                                <td class="lbl-caption">商铺面积:
                                </td>
                                <td>
                                    <input id="ShopSize" name="ShopSize" type="text" value="0" class="easyui-validatebox" />
                                </td>
                            </tr>
                            <tr>

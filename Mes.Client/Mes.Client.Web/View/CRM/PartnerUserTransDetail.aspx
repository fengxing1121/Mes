<%@ Page Title="客户收款" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PartnerUserTransDetail.aspx.cs" Inherits="Mes.Client.Web.View.CRM.PartnerUserTransDetail" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Head" runat="server">
    <script src="../../Script/common/region_select.js"></script>
    <script src="../../Script/forms/crm/jquery.forms.PartnerUserTransDetail.js"></script>
</asp:Content>
                    ...
                    <form id="search_form" method="post">
                        <table>
                            <tr>
                                ...
                                <td style="width: 120px;">
                                    <input style="width: 120px; height: 22px;" name="SolutionCode" type="text" />
                                </td>
                                <td class="lbl-caption">方案名称:</td>
                                <td style="width: 120px;">
                                    <input style="width: 120px; height: 22px;" name="SolutionName" type="text" />
                                </td>

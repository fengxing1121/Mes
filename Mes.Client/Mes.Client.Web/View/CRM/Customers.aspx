<%@ Page Title="客户资料" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Customers.aspx.cs" Inherits="Mes.Client.Web.View.CRM.Customers" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Head" runat="server">
    <script src="../../Script/common/region_select.js"></script>
    <script src="../../Script/forms/crm/jquery.forms.customer.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="server">
    ...
    <div region="east" split="true" title="客户资料管理" style="width: 400px;">
        <div region="center" border="false" style="padding: 0px; border: 0px solid #ccc; overflow: hidden;">
                ...
                <div class="easyui-tabs" border="false">
                    <div title="基本信息" style="padding: 10px" fit="true">
                        ...
                        <table cellpadding="3" id="tbCustomerInfo">
                            <tr>
                                <td class="lbl-caption">经销商:
                                </td>
                                <td>
                                    <input type="text" style="width: 125px;" id="PartnerID" name="PartnerID" class="easyui-combogrid" editable="false" required="true" />
                                </td>
                            </tr>
                            <tr>
                                <td class="lbl-caption">客户名称:<span style="color:red;">*</span>
                                </td>
                                <td style="width: 120px;">
                           ...
                           <tr>
                                ...
                                <td>
                                    <input id="LinkMan" name="LinkMan" type="text" class="easyui-validatebox" 
                                        maxlength="30" />
                                </td>
                            </tr>
                            <tr>

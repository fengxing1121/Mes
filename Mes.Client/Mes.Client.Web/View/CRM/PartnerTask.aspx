<%@ Page Title="我的任务" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PartnerTask.aspx.cs" Inherits="Mes.Client.Web.View.CRM.PartnerTask" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Head" runat="server">
    ...
    <script src="../../Script/forms/crm/jquery.forms.partnertask.js?ver=1.2"></script>
    <style type="text/css">
        input[readonly] {
            border: none;
            background: #f0f0f0;

                        ...
                        { field: 'Modified', title: '更新时间', width: 180, sortable: false, align: 'center' },
                        {
                            ...
                            formatter: function (value, row, index) {
                                if (row['StepNo'] == 2) {
                                    ...
                                    var strReturn = '<a href="#" class="loda-btn" id="sendSplit" text="一键拆单"  onClick="load(\'' + row['DesignerNo'] + '\',\'拆单\',\'' + row['TaskID'] + '\',\'' + row['TaskNo'] + '\',\'' + row['TaskType'] + '\',\'' + row['ReferenceID'] + '\',\'' + row['CustomerID'] + '\');"><span aria-hidden="true" class="loda-icon icon-upload"></span>一键拆单</a>';

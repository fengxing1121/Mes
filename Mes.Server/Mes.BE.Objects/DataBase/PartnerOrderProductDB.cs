...
namespace Mes.BE.Objects
{
    ...
    {
        #region BE_PartnerOrderProduct InsertObject()
        public int InsertPartnerOrderProduct(PartnerOrderProduct obj)
        {
            string sql = @"Insert Into [BE_PartnerOrderProduct](
                              [ProductID]
                             ,[OrderID]
                             ,[ProductGroup]
                             ,[ProductCode]
        ...
        #region BE_PartnerOrderProduct UpdateObject()、DeleteObject()
        ...
        public int DeletePartnerOrderProductByProductID(Guid ProductID)
        {
            string sql = @"Delete [BE_PartnerOrderProduct]  Where ProductID=@ProductID";
        ...
        #region BE_PartnerOrderProduct LoadObject()
        ...
        public List<PartnerOrderProduct> LoadPartnerOrderProductByOrderID(PartnerOrderProduct obj)
        {
            string sql = @"Select 
                              [ProductID]
                             ,[OrderID]
                             ...
                             ,[Modified]
                             ,[ModifiedBy]
                       From [BE_PartnerOrderProduct] With(NoLock) Where OrderID=@OrderID";
        ...
        #region BE_PartnerOrderProduct CountObjects()、ExistsObjects()
        public int CountPartnerOrderProduct()
        {
            string sql = @"Select Count(*) From [BE_PartnerOrderProduct] With(NoLock)";
        ...
        public int CountPartnerOrderProductProductID(Guid ProductID)
        {
            string sql = @"Select Count(*) From [BE_PartnerOrderProduct]  Where ProductID=@ProductID";
        ...
        public bool ExistsPartnerOrderProduct()
        {
            string sql = @"Select Top 1 * From [BE_PartnerOrderProduct] With(NoLock)";
        ...
        public bool ExistsPartnerOrderProductProductID(Guid ProductID)
        {
            string sql = @"Select Top 1 * From [BE_PartnerOrderProduct]  Where ProductID=@ProductID";
        ...
        #region BE_PartnerOrderProduct SearchObject()
        public SearchResult SearchPartnerOrderProduct(SearchPartnerOrderProductArgs args)
        {
            ...
            mbBuilder.AppendFormat(@"Select 
                             ...
                             ,[Modified]
                             ,[ModifiedBy]
                       From [BE_PartnerOrderProduct] With(NoLock) Where 1=1 ");

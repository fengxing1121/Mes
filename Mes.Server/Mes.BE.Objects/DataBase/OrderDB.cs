...
namespace Mes.BE.Objects
{
    public partial class ObjectProxy
    {
        ...
        #region BE_Order InsertObject()
        public int InsertOrder(Order obj)
        {
            string sql = @"Insert Into [BE_Order](
                              [OrderID]
                             ,[OrderNo]
                             ,[OrderType]
                             ,[OutOrderNo]
        ...
        #region BE_Order UpdateObject()、DeleteObject()、LoadObject()
        public int UpdateOrderByOrderID(Order obj)
        {
            string sql = @"Update [BE_Order] Set
                              [OrderNo]=@OrderNo
                             ,[OrderType]=@OrderType
        ...
        public int LoadOrder(Order obj)
        {
            string sql = @"Select 
                              [OrderID]
                             ,[OrderNo]
                             ...
                             ,[Modified]
                             ,[ModifiedBy]
                       From [BE_Order] With(NoLock) Where OrderID=@OrderID";
        ...
        public int UpdateOrder(Order args)
        {
            StringBuilder mbBuilder = new StringBuilder();
            SqlCommand cmd = new SqlCommand();
            mbBuilder.Append(@"UPDATE [BE_Order] SET [Status] = @Status,[StepNo]=@StepNo ");
            ...
            this.SetParameters_Equals(mbBuilder, cmd, "BE_Order].[OrderID", "mbOrderID", args.OrderID);
